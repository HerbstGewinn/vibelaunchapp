...
// (This should ideally be loaded from a config or CMS, but hardcoded for now)
const securityData: SecurityItemData[] = [
  // == Frontend ==
  {
    id: 'https',
    category: 'Frontend',
    title: 'Use HTTPS Everywhere',
    status: 'Handled by Platform', // Default assumption for modern platforms
  ...
  },
  {
    ...
    actions: [
      {
        type: 'vibelaunch', // Example if Vibelaunch offered secret management help
        ...
        learnMoreUrl: 'https://vercel.com/docs/projects/environment-variables' // Example Link
      },
      {
        type: 'lovable',
  ...
  },
  {
    ...
    status: 'To-Do', // Often needs configuration
  ...
  // == Backend ==
  {
    ...
    status: 'To-Do', // Assume custom auth needs check unless platform is known
    ...
    actions: [
      {
        ...
        learnMoreUrl: 'https://supabase.com/docs/guides/auth' // Example
      },
      {
        type: 'lovable',
  ...
  },
  {
  ...
  },
   {
    ...
    status: 'To-Do', // Important if using raw SQL
    ...
    actions: [
      {
        ...
        learnMoreUrl: 'https://vercel.com/docs/security/rate-limits' // Example
      },
      {
        type: 'lovable',
