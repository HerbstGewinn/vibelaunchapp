...
const Ideation = () => {
  const todoItems = [
    { text: "Define core problem your app solves", completed: false },
    { text: "Research target audience and market", completed: false },
    { text: "Analyze competitor apps and features", completed: false },
    { text: "Create user personas and journey maps", completed: false },
    { text: "Brainstorm unique value propositions", completed: false },
    { text: "Validate ideas with potential users - Ask on Reddit Communities & Social Media", completed: false },
  ];
    ...
    <div className="p-6 space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-launch-text-muted max-w-3xl">
          Transform your ideas into a validated app concept through systematic research and brainstorming.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="bg-launch-card-bg border-gray-800 shadow-lg hover:shadow-xl transition-shadow">
          <CardHeader>
            ...
            <CardDescription>Track your idea development progress</CardDescription>
          </CardHeader>
          <CardContent>
            <TodoList items={todoItems} taskId="setup_ideation" category="ideation" />
          </CardContent>
        </Card>
        ...
        <Card className="bg-launch-card-bg border-gray-800 shadow-lg hover:shadow-xl transition-shadow">
          <CardHeader>
            ...
            <CardDescription>Learn ideation and validation techniques</CardDescription>
          </CardHeader>
          <CardContent>
            <AspectRatio ratio={16 / 9}>
              ...
              >
                <source 
                  src="https://xnqbmtsphlduhxrkaopt.supabase.co/storage/v1/object/public/public-files//compressed_tutorial_2.mp4" 
                  type="video/mp4" 
                />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="bg-launch-card-bg border-gray-800 shadow-lg hover:shadow-xl transition-shadow">
          <CardHeader>
            ...
            <CardDescription>Essential resources for idea validation</CardDescription>
          </CardHeader>
      ...
      <PageFeedback category="ideation" />
    </div>
  );
};
